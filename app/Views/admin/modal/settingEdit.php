    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="settingModalShowLabel">Update Pengaturan Antrian</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <?= form_open('/antrian/settingEdit', ['class' => 'settingEdit']) ?>
            <?= csrf_field(); ?>
            ...
            <div class="modal-body">
                ...
                <div class="row pl-5">
                    <div class="col">
                        ...
                        <div class="form-row">
                            <input type="hidden" class="form-check-input" name="buka_awal" data-toggle="toggle" data-size="xs" value="<?= $setBuka; ?>">
                            <p class="text-success" style="font-size: 0.8rem;">Buka: <?= $setBuka; ?></p>
                        </div>

                        <div class="form-row">
                            <input type="radio" class="form-check-input" name="buka_antrian" data-toggle="toggle" data-size="xs" <?php if ($settingBuka == "sesuai") echo "checked"; ?> value="sesuai">
                            <p class="text-success" style="font-size: 0.8rem;"> Sesuai Jam Praktek</p>
                        </div>
                        <div class="form-row">
                            <input type="radio" class="form-check-input" name="buka_antrian" value="15 menit" data-toggle="toggle" data-size="xs" <?php if ($settingBuka == "15 menit") echo "checked"; ?>>
                            <p class="text-success" style="font-size: 0.8rem;"> 15 menit sebelum Jam Praktek</p>
                        </div>

                        <div class="form-row">
                            <input type="radio" class="form-check-input" name="buka_antrian" value="30 menit" data-toggle="toggle" data-size="xs" <?php if ($settingBuka == "30 menit") echo "checked"; ?>>
                            <p class="text-success" style="font-size: 0.8rem;"> 30 menit sebelum Jam Praktek</p>
                        </div>

                        <div class="form-row">
                            <input type="radio" class="form-check-input" value="1 jam" name="buka_antrian" data-toggle="toggle" data-size="xs" <?php if ($settingBuka == "1 jam") echo "checked"; ?>>
                            <p class="text-success" style="font-size: 0.8rem;"> 1 Jam Sebelum Jam Praktek</p>
                        </div>


                        <div class="form-row">
                            <input type="radio" class="form-check-input" value="2 jam" name="buka_antrian" data-toggle="toggle" data-size="xs" <?php if ($settingBuka == "2 jam") echo "checked"; ?>>
                    ...
                    <div class="col">
                        ...
                        <div class="form-row">
                            <input type="hidden" name="tutup_awal" data-toggle="toggle" data-size="xs" value="<?= $setTutup; ?>">
                            <p class="text-success" style="font-size: 0.8rem;">Tutup: <?= $setTutup; ?></p>
                        </div>
                        <div class="form-row">
                            <input type="radio" class="form-check-input" value="sesuai" name="tutup_antrian" data-toggle="toggle" data-size="xs" <?php if ($settingTutup == "sesuai") echo "checked"; ?>>
                            <p class="text-success" style="font-size: 0.8rem;"> Sesuai Jam Tutup</p>
                        </div>
                        <div class="form-row">
                            <input type="radio" class="form-check-input" value="15 menit" name="tutup_antrian" data-toggle="toggle" data-size="xs" <?php if ($settingTutup == "15 menit") echo "checked"; ?>>
                            <p class="text-success" style="font-size: 0.8rem;"> 15 menit sebelum Jam Tutup</p>
                        </div>

                        <div class="form-row">
                            <input type="radio" class="form-check-input" value="30 menit" name="tutup_antrian" data-toggle="toggle" data-size="xs" <?php if ($settingTutup == "30 menit") echo "checked"; ?>>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary simpan">Update Setting</button>
            </div>
